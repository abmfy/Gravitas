...
public:
	...
	/// @param p a point in world coordinates.
	void ComputeDistance(const b2Vec2& p, float* distance, b2Vec2* normal, int childIndex) const;
...
inline void b2Fixture::ComputeDistance(const b2Vec2& p, float* d, b2Vec2* n, int childIndex) const
{
